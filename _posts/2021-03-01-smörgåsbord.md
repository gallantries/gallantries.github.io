...
With instructors and organisers from the [CINECA project](https://cineca-project.eu) and the [Gallantries](https://gallantries.github.io), we developed a workable plan for an online, world-wide event. For this event we decided to go **fully asynchronous**. This meant having all training materials online, including pre-recorded videos, slides, hands-on manuals, and of course the Galaxy servers to run the tutorials on.
