...
With instructors and organisers from the [CINECA project](https://cineca-project.eu), the [Gallantries](https://gallantries.github.io), and the worldwide Galaxy training community, we developed a workable plan for an online, world-wide event. For this event we decided to go **fully asynchronous**. This meant having all training materials online, including pre-recorded videos, slides, hands-on manuals, and of course the Galaxy servers to run the tutorials on.
...
8 people specifically requested captions for the videos in the accommodations section of the registration form, and we were so happy to be able to accommodate them.
